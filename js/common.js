$(function () {
    ...
    $(window).scroll(function () {
        ...
        if (scTop > num) {
            ...
            header.mouseleave(function () {
                header.removeClass("hover_effect");
            });
        } else if (scTop < num) {
    ...
    header.on("mouseenter", function () {
        ...
        $(".gnb_wrap .main_gnb > li")
            .siblings()
            .children(".sub_gnb")
            .removeClass("is_show");
        $(".gnb_wrap .main_gnb > li:nth-of-type(1)")
            .children(".sub_gnb")
            .addClass("is_show");
    });
    ...
    $(".click_list li").click(function () {
        ...
        // console.log(indexNum); console.log(displayNum);
